...
int main(int argc, char *argv[]) {
	...
	MPI_Scatter(image->pixels, (ny/nprocs)* nx, MPI_CHAR, &(local->pixels[radius][0]), (ny/nprocs) * nx, MPI_CHAR, 0, MPI_COMM_WORLD ); // every process should create it's own contiguous correct sized local array
