...
Support for Git version control, directory browsing, status line with glyphs, syntax highlighting, key mappings for running Python with F4 key, searching and PEP8 code standard code highlighting and syntax error checking (linter), and tagbar, using Terminator for screen management/splitting.
